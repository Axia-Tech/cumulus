use allychain_template_runtime::{AccountId, AuraId};
...
pub fn initial_authorities() -> Vec<(AccountId, AuraId)> {
    vec![
        (
            ...
            hex!["3233f745d0860ed64ae9c7f4ea5c0773316fc9265199f312d3f6e8ce08255c10"].unchecked_into(), // Sankar//aura
        ),
        (
            hex!["445f574d57f768ea7e1a2f551bef4298ace99d8895d316352cfc02aececcf26c"].into(),
            hex!["445f574d57f768ea7e1a2f551bef4298ace99d8895d316352cfc02aececcf26c"].unchecked_into(), // Arun//aura
        )
	]
}
