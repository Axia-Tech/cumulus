...
use super::{
	AccountId, AssetId, Assets, Balance, Balances, Call, Event, Origin, AllychainInfo,
	AllychainSystem, AxiaXcm, Runtime, XcmpQueue,
};
use frame_support::{
...
pub type FungiblesTransactor = FungiblesAdapter<
	...
	allychains_common::impls::NonZeroIssuance<AccountId, Assets>,
