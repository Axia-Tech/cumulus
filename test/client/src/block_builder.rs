...
use cumulus_primitives_allychain_inherent::{ParachainInherentData, INHERENT_IDENTIFIER};
...
pub trait BuildParachainBlockData {
	...
	fn build_allychain_block(self, parent_state_root: Hash) -> ParachainBlockData<Block>;
}
