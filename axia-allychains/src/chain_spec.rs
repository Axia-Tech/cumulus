...
/// Specialized `ChainSpec` for the seedling allychain runtime.
...
fn shell_testnet_genesis(allychain_id: AllyId) -> shell_runtime::GenesisConfig {
...
fn seedling_testnet_genesis(
	...
	seedling_runtime::GenesisConfig {
		...
		allychain_info: seedling_runtime::AllychainInfoConfig { allychain_id },
		allychain_system: Default::default(),
	}
}

use allychains_common::{Balance as StatemintBalance, StatemintAuraId};
	...
	CanvasAxiaTestChainSpec::from_genesis(
		...
		move || {
			canvas_axctest_genesis(
				...
				// from the relay chain on the allychain.
				vec![
...
fn aura_accounts() -> Vec<AuraId> {
	vec![
		// Sankar//stash
		hex!["3233f745d0860ed64ae9c7f4ea5c0773316fc9265199f312d3f6e8ce08255c10"].unchecked_into(),
		// Arun//stash
		hex!["445f574d57f768ea7e1a2f551bef4298ace99d8895d316352cfc02aececcf26c"].unchecked_into(),
		// Rakhi//stash
		hex!["c2312f7f9a8190bf76db9dc40e5ef351c4c23e3ae6540932bf2c2d485289c37b"].unchecked_into()
	]
}
...
pub fn canary_chain_spec() -> ChainSpec {
	ChainSpec::from_genesis(
		"Local Testnet",
		"local_testnet",
		ChainType::Local,
